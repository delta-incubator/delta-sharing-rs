...
*/
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn create_credential(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/delta_sharing.catalog.v1.CredentialService/CreateCredential",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "delta_sharing.catalog.v1.CredentialService",
                        "CreateCredential",
                    ),
                );
            self.inner.unary(req, path, codec).await
        ...
        pub async fn get_credential(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/delta_sharing.catalog.v1.CredentialService/GetCredential",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        pub async fn delete_credential(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/delta_sharing.catalog.v1.CredentialService/DeleteCredential",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        pub async fn create_storage_location(
            &mut self,
            request: impl tonic::IntoRequest<super::CreateStorageLocationRequest>,
        ) -> std::result::Result<
            tonic::Response<super::StorageLocation>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/delta_sharing.catalog.v1.CredentialService/CreateStorageLocation",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        pub async fn get_storage_location(
            &mut self,
            request: impl tonic::IntoRequest<super::GetStorageLocationRequest>,
        ) -> std::result::Result<
            tonic::Response<super::StorageLocation>,
            tonic::Status,
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/delta_sharing.catalog.v1.CredentialService/GetStorageLocation",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        pub async fn delete_storage_location(
            &mut self,
            request: impl tonic::IntoRequest<super::DeleteStorageLocationRequest>,
        ) -> std::result::Result<
            tonic::Response<super::StorageLocation>,
            tonic::Status,
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/delta_sharing.catalog.v1.CredentialService/DeleteStorageLocation",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        pub async fn list_storage_locations(
            &mut self,
            request: impl tonic::IntoRequest<super::ListStorageLocationsRequest>,
        ) -> std::result::Result<
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/delta_sharing.catalog.v1.CredentialService/ListStorageLocations",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
