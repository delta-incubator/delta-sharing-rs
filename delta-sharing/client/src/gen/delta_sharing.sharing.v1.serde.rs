...
impl serde::Serialize for CreateShareRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("delta_sharing.sharing.v1.CreateShareRequest", len)?;
        if !self.name.is_empty() {
...
impl<'de> serde::Deserialize<'de> for CreateShareRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct delta_sharing.sharing.v1.CreateShareRequest")
            }
        ...
        deserializer.deserialize_struct("delta_sharing.sharing.v1.CreateShareRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CreateSharingSchemaRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("delta_sharing.sharing.v1.CreateSharingSchemaRequest", len)?;
        if !self.share.is_empty() {
...
impl<'de> serde::Deserialize<'de> for CreateSharingSchemaRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = CreateSharingSchemaRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct delta_sharing.sharing.v1.CreateSharingSchemaRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<CreateSharingSchemaRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(CreateSharingSchemaRequest {
                    share: share__.unwrap_or_default(),
                    schema: schema__,
                })
            }
        }
        deserializer.deserialize_struct("delta_sharing.sharing.v1.CreateSharingSchemaRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for DeleteShareRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("delta_sharing.sharing.v1.DeleteShareRequest", len)?;
        if !self.name.is_empty() {
            struct_ser.serialize_field("name", &self.name)?;
        }
...
impl<'de> serde::Deserialize<'de> for DeleteShareRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct delta_sharing.sharing.v1.DeleteShareRequest")
            }
        ...
        deserializer.deserialize_struct("delta_sharing.sharing.v1.DeleteShareRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for DeleteSharingSchemaRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("delta_sharing.sharing.v1.DeleteSharingSchemaRequest", len)?;
        if !self.name.is_empty() {
            struct_ser.serialize_field("name", &self.name)?;
        }
        if !self.share.is_empty() {
...
impl<'de> serde::Deserialize<'de> for DeleteSharingSchemaRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = DeleteSharingSchemaRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct delta_sharing.sharing.v1.DeleteSharingSchemaRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<DeleteSharingSchemaRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut name__ = None;
                ...
                Ok(DeleteSharingSchemaRequest {
                    name: name__.unwrap_or_default(),
                    share: share__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("delta_sharing.sharing.v1.DeleteSharingSchemaRequest", FIELDS, GeneratedVisitor)
    }
}
