...
/// Generated server implementations.
pub mod delta_sharing_extension_service_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with DeltaSharingExtensionServiceServer.
    #[async_trait]
    pub trait DeltaSharingExtensionService: Send + Sync + 'static {
...
*/
        async fn create_schema(
            &self,
            request: tonic::Request<super::CreateSharingSchemaRequest>,
        ) -> std::result::Result<
...
*/
        async fn delete_schema(
            &self,
            request: tonic::Request<super::DeleteSharingSchemaRequest>,
        ) -> std::result::Result<
            tonic::Response<super::SharingSchemaInfo>,
            tonic::Status,
        >;
...
*/
    #[derive(Debug)]
    pub struct DeltaSharingExtensionServiceServer<T: DeltaSharingExtensionService> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T: DeltaSharingExtensionService> DeltaSharingExtensionServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    for DeltaSharingExtensionServiceServer<T>
    where
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/delta_sharing.sharing.v1.DeltaSharingExtensionService/CreateShare" => {
                    #[allow(non_camel_case_types)]
                    struct CreateShareSvc<T: DeltaSharingExtensionService>(pub Arc<T>);
                    impl<
                        T: DeltaSharingExtensionService,
                    ...
                    for CreateShareSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DeltaSharingExtensionService>::create_share(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/delta_sharing.sharing.v1.DeltaSharingExtensionService/DeleteShare" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteShareSvc<T: DeltaSharingExtensionService>(pub Arc<T>);
                    impl<
                        T: DeltaSharingExtensionService,
                    ...
                    for DeleteShareSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DeltaSharingExtensionService>::delete_share(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/delta_sharing.sharing.v1.DeltaSharingExtensionService/CreateSchema" => {
                    #[allow(non_camel_case_types)]
                    struct CreateSchemaSvc<T: DeltaSharingExtensionService>(pub Arc<T>);
                    impl<
                        T: DeltaSharingExtensionService,
                    > tonic::server::UnaryService<super::CreateSharingSchemaRequest>
                    for CreateSchemaSvc<T> {
                        type Response = super::SharingSchemaInfo;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DeltaSharingExtensionService>::create_schema(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/delta_sharing.sharing.v1.DeltaSharingExtensionService/DeleteSchema" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteSchemaSvc<T: DeltaSharingExtensionService>(pub Arc<T>);
                    impl<
                        T: DeltaSharingExtensionService,
                    > tonic::server::UnaryService<super::DeleteSharingSchemaRequest>
                    for DeleteSchemaSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DeltaSharingExtensionService>::delete_schema(
                                        &inner,
                                        request,
                                    )
                                    .await
    ...
    impl<T: DeltaSharingExtensionService> Clone
    for DeltaSharingExtensionServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
    ...
    impl<T: DeltaSharingExtensionService> tonic::server::NamedService
    for DeltaSharingExtensionServiceServer<T> {
        const NAME: &'static str = "delta_sharing.sharing.v1.DeltaSharingExtensionService";
    }
}
