...
impl serde::Serialize for Resource {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("delta_sharing.catalog.v1.Resource", len)?;
...
impl<'de> serde::Deserialize<'de> for Resource {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct delta_sharing.catalog.v1.Resource")
            }
...
;
        ...
        deserializer.deserialize_struct("delta_sharing.catalog.v1.Resource", FIELDS, GeneratedVisitor)
    }
}
